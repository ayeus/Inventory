...
def process_restock(inventory_data, sanitized_category, item_id, quantity, headers):
    try:
        logger.debug("Processing restock for category %s, item %s, quantity %d", sanitized_category, item_id, quantity)
